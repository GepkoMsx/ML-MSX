...
;       v1.3:
;               - Corrected a small player_config bug when using glide only (thanks Jiherem!).
;               - Renamed some labels AKS to AKG.
;       v1.2:  
...
;               - Declare PLY_AKG_REMOVE_HOOKS (PLY_AKG_REMOVE_HOOKS set 1) to remove hooks (previously was PLY_AKG_USE_HOOKS).
...
;       PLY_AKG_HARDWARE_CPC set 1
;       PLY_AKG_HARDWARE_MSX set 1
;       PLY_AKG_HARDWARE_SPECTRUM set 1
;       PLY_AKG_HARDWARE_PENTAGON set 1
;       PLY_AKG_HARDWARE_PCW set 1
;       PLY_AKG_HARDWARE_SVI set 1
...
;       PLY_AKG_ROM set 1
;       PLY_AKG_ROM_Buffer set #4000 (or wherever).
;       This makes the player a bit slower and slightly bigger.
;       The buffer is PLY_AKG_ROM_BufferSize long (equ250 bytes max, 273 with sound effects).
...
;       - SIZE: Hooks for external calls (play/init) are present by default. Define PLY_AKG_REMOVE_HOOKS to remove them (PLY_AKG_REMOVE_HOOKS set 1).
...
;       PLY_AKG_MANAGE_SOUND_EFFECTS set 1
...
PLY_AKG_HardwareCounter set 0
    IFDEF PLY_AKG_HARDWARE_CPC
PLY_AKG_HardwareCounter set PLY_AKG_HardwareCounter + 1
                ;CPC values are set below.
    ENDIF
    IFDEF PLY_AKG_HARDWARE_MSX
PLY_AKG_HardwareCounter set PLY_AKG_HardwareCounter + 1
PLY_AKG_HARDWARE_MSX_STANDARD set 1
PLY_AKG_HARDWARE_PSG_1789773_HZ set 1
PLY_AKG_HARDWARE_FAST_PSG_ACCESS set 1 ; Indicates out (xx),a is used.
PLY_AKG_FAST_PSG_SELECT_REGISTER set #a0
PLY_AKG_FAST_PSG_SELECT_VALUE set #a1
    ENDIF
    IFDEF PLY_AKG_HARDWARE_SVI
PLY_AKG_HardwareCounter set PLY_AKG_HardwareCounter + 1
PLY_AKG_HARDWARE_MSX_STANDARD set 1
PLY_AKG_HARDWARE_PSG_1789773_HZ set 1
PLY_AKG_HARDWARE_FAST_PSG_ACCESS set 1
PLY_AKG_FAST_PSG_SELECT_REGISTER set #88
PLY_AKG_FAST_PSG_SELECT_VALUE set #8c
    ENDIF
    IFDEF PLY_AKG_HARDWARE_PCW
PLY_AKG_HardwareCounter set PLY_AKG_HardwareCounter + 1
PLY_AKG_HARDWARE_PSG_1000000_HZ set 1
PLY_AKG_HARDWARE_FAST_PSG_ACCESS set 1
PLY_AKG_HARDWARE_CPC_STANDARD set 1
PLY_AKG_FAST_PSG_SELECT_REGISTER set #aa
PLY_AKG_FAST_PSG_SELECT_VALUE set #ab
    ENDIF
    IFDEF PLY_AKG_HARDWARE_SPECTRUM
PLY_AKG_HardwareCounter set PLY_AKG_HardwareCounter + 1
PLY_AKG_HARDWARE_PSG_1773400_HZ set 1
PLY_AKG_HARDWARE_SPECTRUM_OR_PENTAGON set 1
    ENDIF
    IFDEF PLY_AKG_HARDWARE_PENTAGON
PLY_AKG_HardwareCounter set PLY_AKG_HardwareCounter + 1
PLY_AKG_HARDWARE_PSG_1750000_HZ set 1
PLY_AKG_HARDWARE_SPECTRUM_OR_PENTAGON set 1
    ENDIF
...
PLY_AKG_HARDWARE_CPC set 1
    ...
    IFDEF PLY_AKG_HARDWARE_CPC
PLY_AKG_HARDWARE_PSG_1000000_HZ set 1
PLY_AKG_HARDWARE_CPC_STANDARD set 1 ; On CPC/PCW, R7 has a special management.
    ENDIF


        ;Is there a loaded Player Configuration source? If no, use a default configuration.
    IFNDEF PLY_CFG_ConfigurationIsPresent
PLY_CFG_UseSpeedTracks set 1
PLY_CFG_UseEventTracks set 1
PLY_CFG_UseTranspositions set 1
PLY_CFG_UseHardwareSounds set 1
PLY_CFG_UseEffects set 1
PLY_CFG_UseRetrig set 1
                ;PLY_CFG_UseInstrumentRetrig set 1        ;Not tested, the UseRetrig is used instead.
PLY_CFG_UseInstrumentLoopTo set 1
                ;PLY_CFG_NoSoftNoHard set 1               ;Not tested, because always present.
PLY_CFG_NoSoftNoHard_Noise set 1
PLY_CFG_SoftOnly set 1
PLY_CFG_SoftOnly_Noise set 1
PLY_CFG_SoftOnly_ForcedSoftwarePeriod set 1
PLY_CFG_SoftOnly_SoftwareArpeggio set 1
PLY_CFG_SoftOnly_SoftwarePitch set 1
PLY_CFG_SoftToHard set 1
PLY_CFG_SoftToHard_Noise set 1
PLY_CFG_SoftToHard_ForcedSoftwarePeriod set 1
PLY_CFG_SoftToHard_SoftwareArpeggio set 1
PLY_CFG_SoftToHard_SoftwarePitch set 1
PLY_CFG_SoftToHard_HardwarePitch set 1
PLY_CFG_SoftToHard_Retrig set 1
PLY_CFG_HardOnly set 1
PLY_CFG_HardOnly_Noise set 1
PLY_CFG_HardOnly_ForcedHardwarePeriod set 1
PLY_CFG_HardOnly_HardwareArpeggio set 1
PLY_CFG_HardOnly_HardwarePitch set 1
PLY_CFG_HardOnly_Retrig set 1
PLY_CFG_HardToSoft set 1
PLY_CFG_HardToSoft_Noise set 1
PLY_CFG_HardToSoft_ForcedHardwarePeriod set 1
PLY_CFG_HardToSoft_HardwareArpeggio set 1
PLY_CFG_HardToSoft_HardwarePitch set 1
PLY_CFG_HardToSoft_SoftwarePitch set 1
PLY_CFG_HardToSoft_Retrig set 1
PLY_CFG_SoftAndHard set 1
PLY_CFG_SoftAndHard_Noise set 1
PLY_CFG_SoftAndHard_ForcedSoftwarePeriod set 1
PLY_CFG_SoftAndHard_SoftwareArpeggio set 1
PLY_CFG_SoftAndHard_SoftwarePitch set 1
PLY_CFG_SoftAndHard_ForcedHardwarePeriod set 1
PLY_CFG_SoftAndHard_HardwareArpeggio set 1
PLY_CFG_SoftAndHard_HardwarePitch set 1
PLY_CFG_SoftAndHard_Retrig set 1
PLY_CFG_UseEffect_Legato set 1
PLY_CFG_UseEffect_Reset set 1
PLY_CFG_UseEffect_ForcePitchTableSpeed set 1
PLY_CFG_UseEffect_ForceArpeggioSpeed set 1
PLY_CFG_UseEffect_ForceInstrumentSpeed set 1
PLY_CFG_UseEffect_PitchGlide set 1
PLY_CFG_UseEffect_PitchUp set 1
PLY_CFG_UseEffect_PitchDown set 1
PLY_CFG_UseEffect_PitchTable set 1
PLY_CFG_UseEffect_Arpeggio3Notes set 1
PLY_CFG_UseEffect_Arpeggio4Notes set 1
PLY_CFG_UseEffect_ArpeggioTable set 1
PLY_CFG_UseEffect_SetVolume set 1
PLY_CFG_UseEffect_VolumeIn set 1
PLY_CFG_UseEffect_VolumeOut set 1
    ENDIF
...
PLY_AKG_UseSpecialTracks set 1
    ENDIF
...
PLY_AKG_UseSoftOnlyOrHardOnly set 1
    ENDIF
...
PLY_AKG_UseSoftOnlyOrHardOnly_Noise set 1
    ENDIF
...
PLY_AKG_UseInstrumentForcedPeriods set 1
    ENDIF
...
PLY_AKG_UseInstrumentArpeggios set 1
    ENDIF
...
PLY_AKG_UseInstrumentPitchs set 1
    ENDIF
...
PLY_AKG_UseInstrumentForcedPeriodsOrArpeggiosOrPitchs set 1
    ENDIF
...
PLY_AKG_UseRetrig_StoH_HtoS_SandH set 1
    ENDIF
...
PLY_AKG_UseNoise_StoH_HtoS_SandH set 1
    ENDIF
...
PLY_AKG_Use_NoiseRegister set 1
    ENDIF
    IFDEF PLY_CFG_SoftOnly_Noise
PLY_AKG_Use_NoiseRegister set 1
    ENDIF
...
PLY_AKG_UseEffect_VolumeSlide set 1
    ENDIF
...
PLY_AKG_UseEffect_Arpeggio set 1
    ENDIF
...
PLY_AKG_UseEffect_PitchUpOrDown set 1
    ENDIF
...
PLY_AKG_UseEffect_PitchUpOrDown set 1
    ...
    IFDEF PLY_AKG_UseEffect_PitchUpOrDown
PLY_AKG_UseEffect_PitchUpOrDownOrGlide set 1
    ENDIF
...
PLY_AKG_UseEffect_PitchUpOrDownOrGlide set 1
    ...
    IFDEF PLY_AKG_UseEffect_Arpeggio
PLY_AKG_UseEffect_ArpeggioTableOrPitchTable set 1
    ENDIF
...
;A nice trick to manage the offset using the same instructions, according to the player (ROM or not).
    IFDEF PLY_AKG_Rom
PLY_AKG_Offset1b set 0
PLY_AKG_Offset2b set 0   ; Used for instructions such as ld iyh,xx
    ELSE
PLY_AKG_Offset1b set 1
PLY_AKG_Offset2b set 2
    ENDIF

    IFNDEF PLY_AKG_Rom
PLY_AKG_OPCODE_OR_A set #b7 ; Opcode for "or a".
PLY_AKG_OPCODE_SCF set #37 ; Opcode for "scf".
    ELSE
...
PLY_AKG_OPCODE_OR_A set 0 ; 0 * 2 set 0, no carry.
PLY_AKG_OPCODE_SCF set #ff ; 255 * 2 set carry.
PLY_AKG_OPCODE_JP set #c3
    ENDIF

PLY_AKG_OPCODE_ADD_HL_BC_LSB set #09 ; Opcode for "add hl,bc", LSB.
PLY_AKG_OPCODE_ADD_HL_BC_MSB set #00 ; Opcode for "add hl,bc", MSB (fake, it is only 8 bits).
PLY_AKG_OPCODE_SBC_HL_BC_LSB set #42 ; Opcode for "sbc hl,bc", LSB.
PLY_AKG_OPCODE_SBC_HL_BC_MSB set #ed ; Opcode for "sbc hl,bc", MSB.
PLY_AKG_OPCODE_INC_HL set #23 ; Opcode for "inc hl".
PLY_AKG_OPCODE_DEC_HL set #2b ; Opcode for "dec hl".
PLY_AKG_OPCODE_ADD_A_IMMEDIATE set #c6 ; Opcode for "add a,x".
PLY_AKG_OPCODE_SUB_IMMEDIATE set #d6 ; Opcode for "sub x".
...
disarkCounter set 0
    IFNDEF dkws
    MACRO dkws
PLY_AKG_DisarkWordRegionStart_\1
    ENDM
    ENDIF
        ;Disark macro: Word region End.
    IFNDEF dkwe
    MACRO dkwe
PLY_AKG_DisarkWordRegionEnd_\1:
disarkCounter set disarkCounter + 1
    ENDM
    ENDIF
...
disarkCounter set 0
    IFNDEF dkps
    MACRO dkps
PLY_AKG_DisarkPointerRegionStart_\1
    ENDM
    ENDIF
        ;Disark macro: Pointer region End.
    IFNDEF dkpe
    MACRO dkpe
PLY_AKG_DisarkPointerRegionEnd_\1:
disarkCounter set disarkCounter + 1
    ENDM
    ENDIF
...
disarkCounter set 0
    IFNDEF dkbs
    MACRO dkbs
PLY_AKG_DisarkByteRegionStart_\1:
    ENDM
    ENDIF
        ;Disark macro: Byte region End.
    IFNDEF dkbe
    MACRO dkbe
PLY_AKG_DisarkByteRegionEnd_\1:
disarkCounter set disarkCounter + 1
    ENDM
    ENDIF
    ...
    IFNDEF dknr3
    MACRO dknr3
PLY_AKG_DisarkForceNonReferenceDuring3_\1:
disarkCounter set disarkCounter + 1
    ENDM
    ENDIF
    ...
    assert PLY_AKG_Start equ $   ; Makes sure no extra byte were inserted before the hooks.
...
;IN:    HL set music address.
;       A set subsong index (>equ0).
...
PLY_AKG_Init:
    ...
    ld de,4
    add hl,de
    IFDEF PLY_AKG_UseEffect_Arpeggio ; CONFIG SPECIFIC
    ...
    ld de,5                  ; Skips the replay frequency, digichannel, psg count, loop ^art index, end index.
    add hl,de
    ...
    ld (PLY_AKG_Channel3_PtInstrument + PLY_AKG_Offset1b),hl
        ...
        ;The ROM version requires a bit more of setup.
    IFDEF PLY_AKG_Rom
    IFDEF PLY_AKG_UseEffect_PitchUpOrDownOrGlide ; CONFIG SPECIFIC
    xor a
    REPEAT 3, channelNumber, 1
                                ;In the non-ROM code, the MSB is always 0, the LSB is updated. The MSB must be reset for ROM version.
    ld (PLY_AKG_Channel\1_PitchTrack + 1),a

    ld hl,PLY_AKG_Channel\1_PitchTrackIntegerAddOrSubReturn
    ld (PLY_AKG_Channel\1_PitchTrackIntegerAfterAddOrSubJumpInstrAndAddress + 1),hl
    ld hl,PLY_AKG_Channel\1_PitchTrackAddOrSbc_16bitsReturn
    ld (PLY_AKG_Channel\1_PitchTrackAfterAddOrSbcJumpInstrAndAddress + 1),hl

    ld hl,PLY_AKG_Channel\1_PitchTrackDecimalInstrAndValueReturnAfterJp
    ld (PLY_AKG_Channel\1_PitchTrackDecimalInstrAndValueReturnJp + 1),hl
    REND
    ENDIF                    ; PLY_AKG_UseEffect_PitchUpOrDownOrGlide
    ENDIF
    ...
    ld hl,0
    REPEAT 3, channelNumber, 1
    ld (PLY_AKG_Channel\1_SoundEffectData),hl
    REND
    ENDIF                    ; PLY_AKG_MANAGE_SOUND_EFFECTS
...
;IN:    HL set table where the addresses are.
;       B set how many items in the table + 1.
;       C set byte to fill.
...
PLY_AKG_InitTableOrA:
    ...
    ENDIF                    ; PLY_AKG_UseEffect_Arpeggio
    IFDEF PLY_CFG_UseEffect_PitchTable ; CONFIG SPECIFIC
...
PLY_AKG_InitTableJp:
                 ; Disark macro.
    IFDEF PLY_AKG_UseEffect_PitchUpOrDownOrGlide
...
PLY_AKG_Stop:
    ...
    IFDEF PLY_AKG_HARDWARE_MSX_STANDARD
...
PLY_AKG_ReadLinker_NoLoop:
    ...
    ld sp,hl
        ...
        ;Reads the LinkerBlock. SP set LinkerBlock.
...
PLY_AKG_EventTrack_End:
    ...
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_WaitCounter: ld a,0 ; Lines to wait?
    ELSE
    ld a,(PLY_AKG_Channel\1_WaitCounter)
    ENDIF
    sub 1
    jr c,PLY_AKG_Channel\1_ReadTrack
        ;Still some lines to wait.
    ld (PLY_AKG_Channel\1_WaitCounter + PLY_AKG_Offset1b),a
    jp PLY_AKG_Channel\1_ReadCellEnd

PLY_AKG_Channel\1_ReadTrack:
    IFNDEF PLY_AKG_Rom

PLY_AKG_Channel\1_PtTrack: ld hl,0 ; Points on the Cell to read.
    ELSE
    ld hl,(PLY_AKG_Channel\1_PtTrack)
    ENDIF
        ;Reads note data. It can be a note, a wait...

    ld c,(hl)                ; C set data (b5-0) + effect? (b6) + new Instrument? (b7).
    inc hl
    ld a,c
    and %111111              ; A set data.
    cp 60                    ; 0-59: note. "cp" is preferred to "sub" so that the "note" branch (the slowest) is note-ready.
    jr c,PLY_AKG_Channel\1_Note
    sub 60
    jp z,PLY_AKG_Channel\1_MaybeEffects ; 60 set no note, but maybe effects.
    dec a
    jr z,PLY_AKG_Channel\1_Wait ; 61 set wait, no effect.
    dec a
    jr z,PLY_AKG_Channel\1_SmallWait ; 62 set small wait, no effect.
        ;63 set escape code for note, maybe effects.
        ;Reads the note in the next byte (HL has already been incremented).
    ld a,(hl)
    inc hl
    jr PLY_AKG_Channel\1_AfterNoteKnown

        ;Small wait, no effect.
PLY_AKG_Channel\1_SmallWait:
    ...
    ld (PLY_AKG_Channel\1_WaitCounter + PLY_AKG_Offset1b),a
    jr PLY_AKG_Channel\1_BeforeEnd_StoreCellPointer

        ;Wait, no effect.
PLY_AKG_Channel\1_Wait:
...
PLY_AKG_Channel\1_SameInstrument:
        ;No new instrument. The instrument pointer must be reset.
    IFNDEF PLY_AKG_Rom

PLY_AKG_Channel\1_PtBaseInstrument: ld de,0
    ELSE
    ld de,(PLY_AKG_Channel\1_PtBaseInstrument)
    ENDIF
    ld (PLY_AKG_Channel\1_PtInstrument + PLY_AKG_Offset1b),de
    jr PLY_AKG_Channel\1_AfterInstrument

        ;A note has been found, plus maybe an Instrument and effects. A set note. C set still has the New Instrument/Effects flags.
PLY_AKG_Channel\1_Note:
    if \1 = 1                ; Declares this only for the first channel, else refers to it.
    IFNDEF PLY_AKG_Rom
...
PLY_AKG_Channel\1_AfterNoteKnown:
    IFDEF PLY_CFG_UseTranspositions ; CONFIG SPECIFIC
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_Transposition: add a,0 ; Adds the Track transposition.
    ELSE
    ld b,a
    ld a,(PLY_AKG_Channel\1_Transposition + PLY_AKG_Offset1b)
    add a,b
    ENDIF
    ENDIF                    ; PLY_CFG_UseTranspositions
    ld (PLY_AKG_Channel\1_TrackNote + PLY_AKG_Offset1b),a

        ;HL set next data. C set data byte.
    rl c                     ; New Instrument?
    jr nc,PLY_AKG_Channel\1_SameInstrument
...
PLY_AKG_InstrumentsTable: ld de,0 ; Points on the Instruments table of the music (set on song initialization).
    ...
    ld (PLY_AKG_Channel\1_InstrumentOriginalSpeed + PLY_AKG_Offset1b),a
    ELSE
    ld (PLY_AKG_Channel\1_InstrumentSpeed + PLY_AKG_Offset1b),a
    ENDIF                    ; PLY_CFG_UseEffect_ForceInstrumentSpeed
    ld (PLY_AKG_Channel\1_PtInstrument + PLY_AKG_Offset1b),hl
    ld (PLY_AKG_Channel\1_PtBaseInstrument + PLY_AKG_Offset1b),hl ; Useful when playing another note with the same instrument.
    exx
PLY_AKG_Channel\1_AfterInstrument:
    ...
    ld l,a
    ld h,a
    ld (PLY_AKG_Channel\1_Pitch + PLY_AKG_Offset1b),hl
    ENDIF                    ; PLY_AKG_UseEffect_PitchUpOrDownOrGlide
    IFDEF PLY_AKG_UseEffect_Arpeggio ; CONFIG SPECIFIC
    ld (PLY_AKG_Channel\1_ArpeggioTableCurrentStep + PLY_AKG_Offset1b),a
    ENDIF                    ; PLY_AKG_UseEffect_Arpeggio
    IFDEF PLY_CFG_UseEffect_PitchTable ; CONFIG SPECIFIC
    ld (PLY_AKG_Channel\1_PitchTableCurrentStep + PLY_AKG_Offset1b),a
    ENDIF                    ; PLY_CFG_UseEffect_PitchTable
    ld (PLY_AKG_Channel\1_InstrumentStep + PLY_AKG_Offset2b),a

                        ;If the "force instrument speed" effect is used, the instrument speed must be reset to its original value.
    IFDEF PLY_CFG_UseEffect_ForceInstrumentSpeed ; CONFIG SPECIFIC
    IFNDEF PLY_AKG_Rom
    PLY_AKG_Channel\1_InstrumentOriginalSpeed ld a,0
    ELSE
    ld a,(PLY_AKG_Channel\1_InstrumentOriginalSpeed)
    ENDIF
    ld (PLY_AKG_Channel\1_InstrumentSpeed + PLY_AKG_Offset1b),a
    ENDIF                    ; PLY_CFG_UseEffect_ForceInstrumentSpeed
    ...
    ld (PLY_AKG_Channel\1_IsPitch),a
    ENDIF                    ; PLY_AKG_UseEffect_PitchUpOrDownOrGlide

        ;Resets the speed of the Arpeggio and the Pitch.
    IFDEF PLY_AKG_UseEffect_Arpeggio ; CONFIG SPECIFIC
    ld a,(PLY_AKG_Channel\1_ArpeggioBaseSpeed)
    ld (PLY_AKG_Channel\1_ArpeggioTableSpeed),a
    ENDIF                    ; PLY_AKG_UseEffect_Arpeggio
    IFDEF PLY_CFG_UseEffect_PitchTable ; CONFIG SPECIFIC
    ld a,(PLY_AKG_Channel\1_PitchBaseSpeed)
    ld (PLY_AKG_Channel\1_PitchTableSpeed),a
    ENDIF                    ; PLY_CFG_UseEffect_PitchTable

    IFDEF PLY_AKG_UseEffect_Arpeggio ; CONFIG SPECIFIC
    ld hl,(PLY_AKG_Channel\1_ArpeggioTableBase) ; Points to the first value of the Arpeggio.
    ld (PLY_AKG_Channel\1_ArpeggioTable + PLY_AKG_Offset1b),hl
    ENDIF                    ; PLY_AKG_UseEffect_Arpeggio
    IFDEF PLY_CFG_UseEffect_PitchTable ; CONFIG SPECIFIC
    ld hl,(PLY_AKG_Channel\1_PitchTableBase) ; Points to the first value of the Pitch.
    ld (PLY_AKG_Channel\1_PitchTable + PLY_AKG_Offset1b),hl
    ENDIF                    ; PLY_CFG_UseEffect_PitchTable
    ...
    IFDEF PLY_CFG_UseEffects ; CONFIG SPECIFIC
        ;Effects?
    rl c
    jp c,PLY_AKG_Channel\1_ReadEffects
    ENDIF                    ; PLY_CFG_UseEffects

        ;No effects. Nothing more to read for this cell.
PLY_AKG_Channel\1_BeforeEnd_StoreCellPointer:
    ld (PLY_AKG_Channel\1_PtTrack + PLY_AKG_Offset1b),hl
PLY_AKG_Channel\1_ReadCellEnd:
...
PLY_AKG_Channel\1_InvertedVolumeIntegerAndDecimal: ld hl,0
    ELSE
    ld hl,(PLY_AKG_Channel\1_InvertedVolumeIntegerAndDecimal)
    ENDIF
PLY_AKG_Channel\1_InvertedVolumeInteger set PLY_AKG_Channel\1_InvertedVolumeIntegerAndDecimal + PLY_AKG_Offset1b + 1
    IFDEF PLY_AKG_UseEffect_VolumeSlide ; CONFIG SPECIFIC
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_IsVolumeSlide: or a ; Is there a Volume Slide ? Automodified. SCF if yes, OR A if not.
    ELSE
    ld a,(PLY_AKG_Channel\1_IsVolumeSlide)
    add a,a                  ; Creates the carry or not.
    ENDIF
    jr nc,PLY_AKG_Channel\1_VolumeSlide_End

    IFNDEF PLY_AKG_Rom

PLY_AKG_Channel\1_VolumeSlideValue: ld de,0 ; May be negative.
    ELSE
    ld de,(PLY_AKG_Channel\1_VolumeSlideValue)
    ENDIF
    add hl,de
        ;Went below 0?
    bit 7,h
    jr z,PLY_AKG_Channel\1_VolumeNotOverflow
    ld h,0                   ; No need to set L to 0... Shouldn't make any hearable difference.
    jr PLY_AKG_Channel\1_VolumeSetAgain
PLY_AKG_Channel\1_VolumeNotOverflow:
        ;Higher than 15?
    ld a,h
    cp 16
    jr c,PLY_AKG_Channel\1_VolumeSetAgain
    ld h,15
PLY_AKG_Channel\1_VolumeSetAgain:
    ld (PLY_AKG_Channel\1_InvertedVolumeIntegerAndDecimal + PLY_AKG_Offset1b),hl

PLY_AKG_Channel\1_VolumeSlide_End:
    ENDIF                    ; PLY_AKG_UseEffect_VolumeSlide
    ld a,h
    ld (PLY_AKG_Channel\1_GeneratedCurrentInvertedVolume + PLY_AKG_Offset1b),a





        ;Use Arpeggio table? OUT: C set value.
        ;----------------------------------------
    IFDEF PLY_AKG_UseEffect_Arpeggio ; CONFIG SPECIFIC
    ld c,0                   ; Default value of the arpeggio.

    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_IsArpeggioTable: or a ; Is there an arpeggio table? Automodified. SCF if yes, OR A if not.
    ELSE
    ld a,(PLY_AKG_Channel\1_IsArpeggioTable)
    add a,a                  ; Creates the carry or not.
    ENDIF
    jr nc,PLY_AKG_Channel\1_ArpeggioTable_End

        ;We can read the Arpeggio table for a new value.
    IFNDEF PLY_AKG_Rom

PLY_AKG_Channel\1_ArpeggioTable: ld hl,0 ; Points on the data, after the header.
    ELSE
    ld hl,(PLY_AKG_Channel\1_ArpeggioTable)
    ENDIF
    ld a,(hl)
    cp -128                  ; Loop?
    jr nz,PLY_AKG_Channel\1_ArpeggioTable_AfterLoopTest
        ;Loop. Where to?
    inc hl
    ld a,(hl)
    inc hl
    ...
    ld a,(hl)                ; Reads the value. Safe, we know there is no loop here.
        ...
        ;HL set pointer on what is follows.
        ;A set value to use.
PLY_AKG_Channel\1_ArpeggioTable_AfterLoopTest:
    ld c,a

        ;Checks the speed. If reached, the pointer can be saved to read a new value next time.
    ld a,(PLY_AKG_Channel\1_ArpeggioTableSpeed)
    ld d,a
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_ArpeggioTableCurrentStep: ld a,0
    ELSE
    ld a,(PLY_AKG_Channel\1_ArpeggioTableCurrentStep)
    ENDIF
    inc a
    cp d                     ; From 1 to 256.
    jr c,PLY_AKG_Channel\1_ArpeggioTable_BeforeEnd_SaveStep ; C, not NZ, because the current step may be higher than the limit if Force Speed effect is used.
        ;Stores the pointer to read a new value next time.
    inc hl
    ld (PLY_AKG_Channel\1_ArpeggioTable + PLY_AKG_Offset1b),hl

    xor a
PLY_AKG_Channel\1_ArpeggioTable_BeforeEnd_SaveStep:
    ld (PLY_AKG_Channel\1_ArpeggioTableCurrentStep + PLY_AKG_Offset1b),a
PLY_AKG_Channel\1_ArpeggioTable_End:
    ENDIF                    ; PLY_AKG_UseEffect_Arpeggio



        ;Use Pitch table? OUT: DE set pitch value.
    ...
    IFDEF PLY_CFG_UseEffect_PitchTable ; CONFIG SPECIFIC
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_IsPitchTable: or a ; Is there an arpeggio table? Automodified. SCF if yes, OR A if not.
    ELSE
    ld a,(PLY_AKG_Channel\1_IsPitchTable)
    add a,a                  ; Creates the carry or not.
    ENDIF
    jr nc,PLY_AKG_Channel\1_PitchTable_End

        ;Read the Pitch table for a value.
    IFNDEF PLY_AKG_Rom

PLY_AKG_Channel\1_PitchTable: ld sp,0 ; Points on the data, after the header.
    ELSE
    ld sp,(PLY_AKG_Channel\1_PitchTable)
    ENDIF
    ...
    ld a,(PLY_AKG_Channel\1_PitchTableSpeed)
    ld b,a
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_PitchTableCurrentStep: ld a,0
    ELSE
    ld a,(PLY_AKG_Channel\1_PitchTableCurrentStep)
    ENDIF
    inc a
    cp b                     ; From 1 to 256.
    jr c,PLY_AKG_Channel\1_PitchTable_BeforeEnd_SaveStep ; C, not NZ, because the current step may be higher than the limit if Force Speed effect is used.
        ;Advances in the Pitch.
    ld (PLY_AKG_Channel\1_PitchTable + PLY_AKG_Offset1b),hl

    xor a
PLY_AKG_Channel\1_PitchTable_BeforeEnd_SaveStep:
    ld (PLY_AKG_Channel\1_PitchTableCurrentStep + PLY_AKG_Offset1b),a
PLY_AKG_Channel\1_PitchTable_End:
    ENDIF                    ; PLY_CFG_UseEffect_PitchTable
        ...
        ;------------------------------------------------------------------------------------------
    IFNDEF PLY_AKG_UseEffect_PitchUpOrDownOrGlide ; CONFIG SPECIFIC
    ld hl,0                  ; No pitch.
...
PLY_AKG_Channel\1_SoundStream_RelativeModifierAddress: ; Put here, no need for better place (see the real label below, with the same name).
    IFDEF PLY_AKG_UseEffect_ArpeggioTableOrPitchTable ; CONFIG SPECIFIC
    jr PLY_AKG_Channel\1_AfterArpeggioPitchVariables

    IFDEF PLY_AKG_UseEffect_Arpeggio ; CONFIG SPECIFIC
                 ; Disark macro.
PLY_AKG_Channel\1_ArpeggioTableSpeed: db 0
PLY_AKG_Channel\1_ArpeggioBaseSpeed: db 0
PLY_AKG_Channel\1_ArpeggioTableBase: dw 0
                 ; Disark macro.
    ENDIF                    ; PLY_AKG_UseEffect_Arpeggio
    IFDEF PLY_CFG_UseEffect_PitchTable ; CONFIG SPECIFIC
                 ; Disark macro.
PLY_AKG_Channel\1_PitchTableSpeed: db 0
PLY_AKG_Channel\1_PitchBaseSpeed: db 0
PLY_AKG_Channel\1_PitchTableBase: dw 0
                 ; Disark macro.
    ENDIF                    ; PLY_CFG_UseEffect_PitchTable
PLY_AKG_Channel\1_AfterArpeggioPitchVariables:
    ENDIF                    ; PLY_AKG_UseEffect_ArpeggioTableOrPitchTable
    ENDIF                    ; PLY_AKG_ROM
    ELSE                     ; PLY_AKG_UseEffect_PitchUpOrDownOrGlide
    IFNDEF PLY_AKG_Rom

PLY_AKG_Channel\1_Pitch: ld hl,0
PLY_AKG_Channel\1_IsPitch: or a ; Is there a Pitch? Automodified. SCF if yes, OR A if not.
    ELSE
    ld hl,(PLY_AKG_Channel\1_Pitch)
    ld a,(PLY_AKG_Channel\1_IsPitch)
    add a,a                  ; Creates the carry or not.
    ENDIF
    jr nc,PLY_AKG_Channel\1_Pitch_End
...
PLY_AKG_Channel\1_PitchTrack: ld bc,0 ; Value from the user. ALWAYS POSITIVE. Does not evolve. B is always 0.
    ELSE
    ld bc,(PLY_AKG_Channel\1_PitchTrack)
    ENDIF

    or a                     ; Required if the code is changed to sbc.
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_PitchTrackAddOrSbc_16bits: nop : add hl,bc ; WILL BE AUTOMODIFIED to add or sbc. But SBC requires 2*8 bits! Damn.
    ELSE
    jp PLY_AKG_Channel\1_PitchTrackAddOrSbc_16bits ; Calls a code that holds the instruction.
PLY_AKG_Channel\1_PitchTrackAddOrSbc_16bitsReturn:
    ENDIF

        ;Makes the decimal part evolves.
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_PitchTrackDecimalCounter: ld a,0
PLY_AKG_Channel\1_PitchTrackDecimalInstr: add a,0 ; Value from the user. WILL BE AUTOMODIFIED to add or sub.
    PLY_AKG_Channel\1_PitchTrackDecimalValue set PLY_AKG_Channel\1_PitchTrackDecimalInstr + 1
    ELSE
    ld a,(PLY_AKG_Channel\1_PitchTrackDecimalValue)
    ld b,a
    ld a,(PLY_AKG_Channel\1_PitchTrackDecimalCounter)
        ;Add a,b or sub b? Lets the subcode decide. It will return just below.
    jp PLY_AKG_Channel\1_PitchTrackDecimalInstrAndValue
PLY_AKG_Channel\1_PitchTrackDecimalInstrAndValueReturnAfterJp:
    ENDIF
    ld (PLY_AKG_Channel\1_PitchTrackDecimalCounter + PLY_AKG_Offset1b),a

    jr nc,PLY_AKG_Channel\1_PitchNoCarry
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_PitchTrackIntegerAddOrSub: inc hl ; WILL BE AUTOMODIFIED to inc hl/dec hl
    ELSE
    jp PLY_AKG_Channel\1_PitchTrackIntegerAddOrSub ; Calls a code that holds the instruction.
PLY_AKG_Channel\1_PitchTrackIntegerAddOrSubReturn:
    ENDIF
PLY_AKG_Channel\1_PitchNoCarry:
    ld (PLY_AKG_Channel\1_Pitch + PLY_AKG_Offset1b),hl

    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_SoundStream_RelativeModifierAddress: ; This must be placed at the any location to allow reaching the variables via IX/IY.
    ENDIF
    IFDEF PLY_CFG_UseEffect_PitchGlide ; CONFIG SPECIFIC
        ;Glide?
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_GlideDirection: ld a,0 ; 0 set no glide. 1 set glide/pitch up. 2 set glide/pitch down.
    ELSE
    ld a,(PLY_AKG_Channel\1_GlideDirection)
    ENDIF
    or a                     ; Is there a Glide?
    jr z,PLY_AKG_Channel\1_Glide_End

    ld (PLY_AKG_Channel\1_Glide_SaveHL + PLY_AKG_Offset1b),hl
    ld c,l
    ld b,h
        ;Finds the period of the current note.
    ex af,af'
    ld a,(PLY_AKG_Channel\1_TrackNote + PLY_AKG_Offset1b)
    ...
    add hl,sp
    ld sp,hl
    pop hl                   ; HL set current note period.
    dec sp
...
PLY_AKG_Channel\1_GlideToReach: ld bc,0 ; Period to reach (note given by the user, converted to period).
    ELSE
    ld bc,(PLY_AKG_Channel\1_GlideToReach)
    ENDIF
        ;Have we reached the glide destination?
        ;Depends on the direction.
    rra                      ; If 1, the carry is set. If 2, no.
    jr nc,PLY_AKG_Channel\1_GlideDownCheck
        ;Glide up. Check.
        ;The glide period should be lower than the current pitch.
    or a
    sbc hl,bc
    jr nc,PLY_AKG_Channel\1_Glide_BeforeEnd ; If not reached yet, continues the pitch.
    jr PLY_AKG_Channel\1_GlideOver

PLY_AKG_Channel\1_GlideDownCheck:
        ;The glide period should be higher than the current pitch.
    sbc hl,bc                ; No carry, no need to remove it.
    jr c,PLY_AKG_Channel\1_Glide_BeforeEnd ; If not reached yet, continues the pitch.
PLY_AKG_Channel\1_GlideOver:
    ...
    jr PLY_AKG_Channel\1_Glide_End
    ELSE
    IFNDEF PLY_AKG_Rom
...
PLY_AKG_Channel\1_AfterArpeggioPitchVariables:
    ...
    IFDEF PLY_CFG_UseEffect_PitchGlide ; CONFIG SPECIFIC
PLY_AKG_Channel\1_Glide_BeforeEnd:
    IFNDEF PLY_AKG_Rom

PLY_AKG_Channel\1_Glide_SaveHL: ld hl,0 ; Restores HL.
    ELSE
    ld hl,(PLY_AKG_Channel\1_Glide_SaveHL)
    ENDIF
PLY_AKG_Channel\1_Glide_End:
    ENDIF                    ; PLY_CFG_UseEffect_PitchGlide
...
PLY_AKG_Channel\1_Pitch_End:
    ENDIF                    ; PLY_AKG_UseEffect_PitchUpOrDownOrGlide


    add hl,de                ; Adds the Pitch Table value.
    ld (PLY_AKG_Channel\1_GeneratedCurrentPitch + PLY_AKG_Offset1b),hl
    IFDEF PLY_AKG_UseEffect_Arpeggio ; CONFIG SPECIFIC
    ld a,c
    ld (PLY_AKG_Channel\1_GeneratedCurrentArpNote + PLY_AKG_Offset1b),a
    ENDIF                    ; PLY_AKG_UseEffect_Arpeggio
...
;-------------------------------------------------------------------------------------
    ...
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_PlayInstrument_RelativeModifierAddress: ; This must be placed at the any location to allow reaching the variables via IX/IY.
    ENDIF

        ;What note to play?
    IFNDEF PLY_AKG_Rom

PLY_AKG_Channel\1_GeneratedCurrentPitch: ld hl,0 ; The pitch to add to the real note, according to the Pitch Table + Pitch/Glide effect.
    ELSE
    ld hl,(PLY_AKG_Channel\1_GeneratedCurrentPitch)
    ENDIF
    IFDEF PLY_AKG_UseEffect_Arpeggio ; CONFIG SPECIFIC
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_TrackNote: ld a,0
PLY_AKG_Channel\1_GeneratedCurrentArpNote: add 0 ; Adds the arpeggio value.
    ELSE
    ld a,(PLY_AKG_Channel\1_TrackNote)
    ld e,a
    ld a,(PLY_AKG_Channel\1_GeneratedCurrentArpNote)
    add a,e
    ENDIF
    ld e,a
    ld d,0
    ELSE                     ; PLY_AKG_UseEffect_Arpeggio
    IFNDEF PLY_AKG_Rom

PLY_AKG_Channel\1_TrackNote: ld de,0 ; Not automodified, stays this way.
    ELSE
    ld a,(PLY_AKG_Channel\1_TrackNote) ; In ROM, MUST pass by a variable anyway to be analog to if Arpeggio is used (see above).
    ld e,a
    ld d,0
    ENDIF
    ENDIF                    ; PLY_AKG_UseEffect_Arpeggio
    exx
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_InstrumentStep: ld iyl,0

PLY_AKG_Channel\1_PtInstrument: ld hl,0 ; Instrument data to read (past the header).
    if \1 = 1                ; Different code for the first channel.
PLY_AKG_Channel\1_GeneratedCurrentInvertedVolume: ld de,%11100000 * 256 + 15 ; R7, shift twice TO THE LEFT. By default, the noise is cut (111), the sound is on (most usual case).
    else
PLY_AKG_Channel\1_GeneratedCurrentInvertedVolume: ld e,15
    nop                      ; Stupid, but required for relative registers to reach addresses independently of the channels.
    endif
    ELSE
    ld a,(PLY_AKG_Channel\1_InstrumentStep)
    ld iyl,a
    ld hl,(PLY_AKG_Channel\1_PtInstrument)
    ld a,(PLY_AKG_Channel\1_GeneratedCurrentInvertedVolume)
    ld e,a
    if \1 = 1
...
;       D set Reg7
;       E set inverted volume.
;       D' set 0, E' set note (instrument + Track transposition).
;       HL' set track pitch.
    ...
    IFDEF PLY_AKG_Rom
    ld a,(PLY_AKG_Channel\1_InstrumentSpeed)
    ld b,a
    ENDIF
    ld a,iyl
    inc a
    IFNDEF PLY_AKG_Rom
PLY_AKG_Channel\1_InstrumentSpeed: cp 0 ; (>0)
    ELSE
    cp b
    ENDIF
    jr c,PLY_AKG_Channel\1_SetInstrumentStep ; Checks C, not only NZ because since the speed can be changed via an effect, the step can get beyond the limit, this must be taken in account.
        ;The speed is reached. We can go to the next line on the next frame.
    ld (PLY_AKG_Channel\1_PtInstrument + PLY_AKG_Offset1b),hl
    xor a
PLY_AKG_Channel\1_SetInstrumentStep:
    ld (PLY_AKG_Channel\1_InstrumentStep + PLY_AKG_Offset2b),a


        ;Saves the software period and volume for the PSG to send later.
    ld a,e
    ld (PLY_AKG_PSGReg\1),a  ; Reaches register/label 8/9/10.
...
; fix for calculating in parameters
PLY_AKG_PSGReg1 equ PLY_AKG_PSGReg8
PLY_AKG_PSGReg2 equ PLY_AKG_PSGReg9
PLY_AKG_PSGReg3 equ PLY_AKG_PSGReg10
...
;-------------------------------------------
    IFDEF PLY_AKG_MANAGE_SOUND_EFFECTS
                ;IN : A set R7
                ;OUT: A set R7, possibly modified.
...
PLY_AKG_PSGReg6_8_Instr: ld hl,0 ; L is R6, H is R8. Faster to set a 16 bits register than 2 8-bit.
    PLY_AKG_PSGReg6 set PLY_AKG_PSGReg6_8_Instr + 1
    PLY_AKG_PSGReg8 set PLY_AKG_PSGReg6_8_Instr + 2
    ELSE
...
PLY_AKG_PSGReg8_Instr: ld h,0
    PLY_AKG_PSGReg8 set PLY_AKG_PSGReg8_Instr + 1
    ELSE
...
PLY_AKG_PSGReg9_10_Instr: ld hl,0 ; L is R9, H is R10. Faster to set a 16 bits register than 2 8-bit.
    PLY_AKG_PSGReg9 set PLY_AKG_PSGReg9_10_Instr + 1
    PLY_AKG_PSGReg10 set PLY_AKG_PSGReg9_10_Instr + 2
    ELSE
...
PLY_AKG_PSGHardwarePeriod_Instr: ld hl,0
    ...
    ENDIF
    IFDEF PLY_AKG_HARDWARE_FAST_PSG_ACCESS

    ld b,a                   ; Preserves R7.
    ld a,7
    out (PLY_AKG_FAST_PSG_SELECT_REGISTER),a ; Register.
    ld a,b
    out (PLY_AKG_FAST_PSG_SELECT_VALUE),a ; Value.
...
PLY_AKG_Retrig: or 0         ; 0 set no retrig. Else, should be >0xf to be sure the old value becomes a sentinel (i.e. unreachable) value.
...
PLY_AKG_Channel\1_MaybeEffects:
        ;There is one wait in all cases.
        ;xor a                  ;A is supposed to be 0.
    ld (PLY_AKG_Channel\1_WaitCounter + PLY_AKG_Offset1b),a
    IFNDEF PLY_CFG_UseEffects ; CONFIG SPECIFIC
    jp PLY_AKG_Channel\1_BeforeEnd_StoreCellPointer
    ELSE
    bit 6,c                  ; Effects?
    jp z,PLY_AKG_Channel\1_BeforeEnd_StoreCellPointer
        ;Manage effects.

;Reads the effects.
;IN:    HL set Points on the effect blocks
;OUT:   HL set Points after on the effect blocks
PLY_AKG_Channel\1_ReadEffects:
    ld iy,PLY_AKG_Channel\1_SoundStream_RelativeModifierAddress
    ld ix,PLY_AKG_Channel\1_PlayInstrument_RelativeModifierAddress
    ld de,PLY_AKG_Channel\1_BeforeEnd_StoreCellPointer
        ;Only adds a jump if this is not the last channel, as the code only need to jump below.
    if \1 != 3
    jr PLY_AKG_Channel_ReadEffects
    endif
    ENDIF                    ; PLY_CFG_UseEffects
PLY_AKG_Channel\1_ReadEffectsEnd:
    ...
    IFDEF PLY_CFG_UseEffects ; CONFIG SPECIFIC
;IN:    HL set Points on the effect blocks
;       DE set Where to go to when over.
;       IX set Address from which the data of the instrument are modified.
;       IY set Address from which data of the channels (pitch, volume, etc) are modified.
;OUT:   HL set Points after on the effect blocks
PLY_AKG_Channel_ReadEffects:
    assert $ equ PLY_AKG_Channel3_ReadEffectsEnd ; Makes sure this code is directly below the one above.
...
;IN:    HL set pointer on the Instrument data cell to read.
;       IX set can be modified.
;       IYL set Instrument step (>equ0). Useful for retrig.
;       SP set normal use of the stack, do not pervert it!
;       D set register 7, as if it was the channel 3 (so, bit 2 and 5 filled only).
;             By default, the noise is OFF, the sound is ON, so no need to do anything if these values match.
;       E set inverted volume.
;       A set SET BELOW: first byte of the data, shifted of 3 bits to the right.
;       B set SET BELOW: first byte of the data, unmodified.
;       HL' set track pitch.
;       DE' set 0 / note (instrument + Track transposition).
;       BC' set temp, use at will.

;OUT:   HL set new pointer on the Instrument (may be on the empty sound). If not relevant, any value can be returned, it doesn't matter.
;       IYL set Not 0 if retrig for this channel.
;       D set register 7, updated, as if it was the channel 1 (so, bit 2 and 5 filled only).
;       E set volume to encode (0-16).
;       HL' set software period. If not relevant, do not set it.
;       DE' set output period.

PLY_AKG_BitForSound set 2
PLY_AKG_BitForNoise set 5
...
;IN:    HL set the next bytes to read.
;       HL' set note + transposition.
;       B set contains three bits:
;               b7: forced period? (if yes, the two other bits are irrelevant)
;               b6: arpeggio?
;               b5: pitch?
;       C set do not modify.
;       Carry: Simple sound?
;OUT:   B set shift three times to the left.
;       C set unmodified.
;       HL set advanced.
;       HL' set calculated period.
PLY_AKG_S_Or_H_CheckIfSimpleFirst_CalculatePeriod:
    ...
    exx
    ex de,hl                 ; Now HL set track note + transp, DE is track pitch.
    add hl,hl
...
;OUT:   HL' set frequency.
;       A set shifted inverted ratio (xxx000), ready to be used in a JR to multiply/divide the frequency.
;       B set bit states, shifted four times to the left (for StoH/HtoS, the msb will be "pitch shift?") (hardware for SoftTohard, software for HardToSoft).
    IFDEF PLY_CFG_UseHardwareSounds ; CONFIG SPECIFIC
...
PLY_AKG_SHoHS_AfterNoise:
    ...
    ld c,(hl)                ; C set ratio, kept for later.
    ld b,c
    inc hl
...
;----------------------------------------------------------------
;For all effects:
;IN:    DE' set Points on the data of this effect.
;       IX set Address from which the data of the instrument are modified.
;       IY set Address from which the data of the channels (pitch, volume, etc) are modified.
;       HL set Must NOT be modified.
;       WARNING, we are on auxiliary registers!

;       SP set Can be modified at will.

;OUT:   DE' set Points after on the data of this effect.
...
PLY_AKG_Effect_PitchDown:
    ...
    ENDIF                    ; PLY_CFG_UseEffect_PitchDown
    IFDEF PLY_AKG_UseEffect_PitchUpOrDown ; CONFIG SPECIFIC
PLY_AKG_Effect_PitchUpDown_Common: ; The Pitch up will jump here.
    ...
    jp PLY_AKG_Channel_RE_EffectReturn
    ENDIF                    ; PLY_AKG_UseEffect_PitchUpOrDown
...
;The period table for each note (from 0 to 127 included).
                 ; Disark macro.
    IFDEF PLY_AKG_HARDWARE_PSG_1000000_HZ ; PSG running to 1000000 Hz.
PLY_AKG_PeriodTable:
    dw 3822,3608,3405,3214,3034,2863,2703,2551,2408,2273,2145,2025 ; Octave 0
    dw 1911,1804,1703,1607,1517,1432,1351,1276,1204,1136,1073,1012 ; Octave 1
    dw 956,902,851,804,758,716,676,638,602,568,536,506 ; Octave 2
    dw 478,451,426,402,379,358,338,319,301,284,268,253 ; Octave 3
    dw 239,225,213,201,190,179,169,159,150,142,134,127 ; Octave 4
    dw 119,113,106,100,95,89,84,80,75,71,67,63 ; Octave 5
    dw 60,56,53,50,47,45,42,40,38,36,34,32 ; Octave 6
    dw 30,28,27,25,24,22,21,20,19,18,17,16 ; Octave 7
    dw 15,14,13,13,12,11,11,10,9,9,8,8 ; Octave 8
    dw 7,7,7,6,6,6,5,5,5,4,4,4 ; Octave 9
    dw 4,4,3,3,3,3,3,2       ; ,2,2,2,2                                                    ; Octave 10
    ENDIF

    IFDEF PLY_AKG_HARDWARE_PSG_1773400_HZ ; PSG running to 1773400 Hz.
PLY_AKG_PeriodTable:
    ...
    IFDEF PLY_AKG_HARDWARE_PSG_1789773_HZ ; PSG running to 1789773 Hz.
PLY_AKG_PeriodTable:
    ...
    IFDEF PLY_AKG_HARDWARE_PSG_1750000_HZ ; PSG running to 1750000 Hz.
PLY_AKG_PeriodTable:
...
PLY_AKG_PeriodTable_End:
    assert PLY_AKG_PeriodTable_End - PLY_AKG_PeriodTable equ 256 ; 128 possible notes, no need to provide more.


;Buffer used for the ROM player. This part needs to be set to RAM. PLY_AKG_ROM_Buffer must be set.
;     IFDEF PLY_AKG_Rom

;     PLY_AKG_BufferOffset set 0

; ;Generic data.
;     IFDEF PLY_CFG_UseEventTracks
; PLY_AKG_Event                                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
; PLY_AKG_CurrentSpeed                                            set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_BaseNoteIndex                                           set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_PatternDecreasingHeight                                 set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_TickDecreasingCounter                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     IFDEF PLY_CFG_UseSpeedTracks
; PLY_AKG_SpeedTrack_WaitCounter                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
;     IFDEF PLY_CFG_UseEventTracks
; PLY_AKG_EventTrack_WaitCounter                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
;     IFDEF PLY_CFG_UseHardwareSounds
; PLY_AKG_PSGReg13_OldValue                                       set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_PSGReg13_Instr                                       set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     IFDEF PLY_CFG_UseRetrig
; PLY_AKG_Retrig                                       set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
;     ENDIF
; PLY_AKG_Channel_RE_ReadNextEffectInBlock                                       set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;         ;Words
; PLY_AKG_ReadLinker_PtLinker                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     IFDEF PLY_CFG_UseSpeedTracks
; PLY_AKG_SpeedTrack_PtTrack                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
;     IFDEF PLY_CFG_UseEventTracks
; PLY_AKG_EventTrack_PtTrack                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
;     IFDEF PLY_AKG_UseEffect_Arpeggio
; PLY_AKG_ArpeggiosTable                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
;     IFDEF PLY_CFG_UseEffect_PitchTable
; PLY_AKG_PitchesTable                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
; PLY_AKG_InstrumentsTable                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     IFDEF PLY_CFG_UseEffects
;         ;For ROM, only one is used, the second is the same, but it makes it faster on non-ROM as it avoid reading the memory.
; PLY_AKG_Channel_ReadEffects_EffectBlocks1                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
; PLY_AKG_EmptyInstrumentDataPt                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_SaveSp                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_PSGReg01_Instr                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_PSGReg23_Instr                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_PSGReg45_Instr                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_PSGReg6_8_Instr                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_PSGReg6                                         set PLY_AKG_PSGReg6_8_Instr + 0
; PLY_AKG_PSGReg8                                         set PLY_AKG_PSGReg6_8_Instr + 1
; PLY_AKG_PSGReg9_10_Instr                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_PSGReg9                                         set PLY_AKG_PSGReg9_10_Instr + 0
; PLY_AKG_PSGReg10                                        set PLY_AKG_PSGReg9_10_Instr + 1
;     IFDEF PLY_CFG_UseHardwareSounds
; PLY_AKG_PSGHardwarePeriod_Instr                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
; PLY_AKG_Channel_ReadEffects_EndJumpInstrAndAddress                                   set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 3 ; 3 bytes. JP xxxx
;     IFDEF PLY_CFG_UseEffect_PitchGlide
; PLY_AKG_Effect_GlideWithNoteSaveDE                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
; PLY_AKG_TempPlayInstrumentJumpInstrAndAddress                     set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 3 ; 3 bytes. JP xxxx

;         ;Section specific to each channel.
;     REPEAT 3, channelNumber, 1
; PLY_AKG_Channel\1_SoundStream_RelativeModifierAddress              set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset
; PLY_AKG_Channel\1_PlayInstrument_RelativeModifierAddress           set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset

;         ;Bytes
;     IFDEF PLY_CFG_UseTranspositions
; PLY_AKG_Channel\1_Transposition                    set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
; PLY_AKG_Channel\1_WaitCounter                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     IFDEF PLY_AKG_UseEffect_VolumeSlide
; PLY_AKG_Channel\1_IsVolumeSlide                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
;     IFDEF PLY_AKG_UseEffect_Arpeggio
; PLY_AKG_Channel\1_IsArpeggioTable                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
;     IFDEF PLY_CFG_UseEffect_PitchTable
; PLY_AKG_Channel\1_IsPitchTable                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
;     IFDEF PLY_AKG_UseEffect_PitchUpOrDownOrGlide
; PLY_AKG_Channel\1_IsPitch                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
;     IFDEF PLY_CFG_UseEffect_ForceInstrumentSpeed
; PLY_AKG_Channel\1_InstrumentOriginalSpeed                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
; PLY_AKG_Channel\1_InstrumentSpeed                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_InstrumentStep                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     IFDEF PLY_AKG_UseEffect_Arpeggio
; PLY_AKG_Channel\1_ArpeggioTableCurrentStep                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_GeneratedCurrentArpNote                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_ArpeggioBaseSpeed                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_ArpeggioTableSpeed                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
;     IFDEF PLY_CFG_UseEffect_PitchTable
; PLY_AKG_Channel\1_PitchTableCurrentStep                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_PitchBaseSpeed                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_PitchTableSpeed                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
;     IFDEF PLY_AKG_UseEffect_PitchUpOrDownOrGlide
; PLY_AKG_Channel\1_PitchTrackDecimal                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_PitchTrackDecimalCounter                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
; PLY_AKG_Channel\1_TrackNote                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     IFDEF PLY_CFG_UseEffect_PitchGlide
; PLY_AKG_Channel\1_GlideDirection                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     ENDIF
; PLY_AKG_Channel\1_GeneratedCurrentInvertedVolume                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;         ;Words
; PLY_AKG_Channel\1_PtTrack                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     IFDEF PLY_AKG_UseEffect_Arpeggio
; PLY_AKG_Channel\1_ArpeggioTable                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_ArpeggioTableBase                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
;     IFDEF PLY_AKG_UseEffect_PitchUpOrDownOrGlide
; PLY_AKG_Channel\1_PitchTrack                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
;     IFDEF PLY_CFG_UseEffect_PitchTable
; PLY_AKG_Channel\1_PitchTable                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_PitchTableBase                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
; PLY_AKG_Channel\1_EffectBlocks1                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_EffectBlocks2                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_InvertedVolumeIntegerAndDecimal                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_Pitch                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_PtInstrument                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_PtBaseInstrument                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_VolumeSlideValue                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     IFDEF PLY_CFG_UseEffect_PitchGlide
; PLY_AKG_Channel\1_GlideToReach                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_Glide_SaveHL                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     ENDIF
;     IFDEF PLY_AKG_UseEffect_PitchUpOrDownOrGlide
; PLY_AKG_Channel\1_PitchTrackDecimalInstrAndValue    set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2 ; Add/sub b, xx.
; PLY_AKG_Channel\1_PitchTrackDecimalInstr           set PLY_AKG_Channel\1_PitchTrackDecimalInstrAndValue + 0
; PLY_AKG_Channel\1_PitchTrackDecimalValue           set PLY_AKG_Channel\1_PitchTrackDecimalInstrAndValue + 1
;         ;The add/sub must be followed by the return JP.
; PLY_AKG_Channel\1_PitchTrackDecimalInstrAndValueReturnJp    set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 3 ; JP xxxx.
;     ENDIF

; PLY_AKG_Channel\1_GeneratedCurrentPitch                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     IFDEF PLY_AKG_UseEffect_PitchUpOrDownOrGlide
; PLY_AKG_Channel\1_PitchTrackAddOrSbc_16bits          set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;         ;3 bytes.
; PLY_AKG_Channel\1_PitchTrackAfterAddOrSbcJumpInstrAndAddress             set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 3 ; 3 bytes. JP xxxx.
; PLY_AKG_Channel\1_PitchTrackIntegerAddOrSub                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_PitchTrackIntegerAfterAddOrSubJumpInstrAndAddress                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 3 ; 3 bytes. JP xxxx.
;     ENDIF
;     REND

;         ;The buffers for sound effects (if any), for each channel. They are treated apart, because they must be consecutive.
;     IFDEF PLY_AKG_MANAGE_SOUND_EFFECTS
; PLY_AKG_PtSoundEffectTable                                      set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
;     REPEAT 3, channelNumber, 1
; PLY_AKG_Channel\1_SoundEffectData                  set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 2
; PLY_AKG_Channel\1_SoundEffectInvertedVolume        set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_SoundEffectCurrentStep           set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
; PLY_AKG_Channel\1_SoundEffectSpeed                 set PLY_AKG_ROM_Buffer + PLY_AKG_BufferOffset : PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 1
;     if channelNumber != 3
;     PLY_AKG_BufferOffset set PLY_AKG_BufferOffset + 3 ; Padding of 3, but only necessary for channel 1 and 2.
;     endif
;     REND
;     ENDIF
...
;     PLY_AKG_ROM_BufferSize set PLY_AKG_BufferOffset

;     expectedBufferSize set 250
;     IFNDEF PLY_AKG_MANAGE_SOUND_EFFECTS
;     assert PLY_AKG_BufferOffset <set expectedBufferSize ; Decreases when using the Player Configuration.
;     ELSE
;     assert PLY_AKG_BufferOffset <set (expectedBufferSize + 23) ; With sound effects, it takes a bit more memory.
;     ENDIF
